...
for month in range(1, 13):
    ...
    url = f"https://www.ncei.noaa.gov/data/climate-forecast-system/access/operational-9-month-forecast/6-hourly-flux/{year}/{year}{month:02d}/{year}{month:02d}01/{year}{month:02d}0100/"
    ...
    # Regular expression to match files like "flxf*.grb2" but not ".md5" or other extensions
    pattern = re.compile(r'flxf.*\.grb2$')
